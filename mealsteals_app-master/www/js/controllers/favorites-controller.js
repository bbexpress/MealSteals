...
.controller('FavoritesCtrl', function(Timestamp, $ionicHistory, Auth, Profile, $firebaseAuth, $cordovaSocialSharing, $firebaseArray, $firebaseObject, $scope, $rootScope, $stateParams, Location, $location, $interval, $timeout, $ionicLoading, $ionicScrollDelegate, $ionicPopup, $ionicModal, $q, $compile, $interval) {
