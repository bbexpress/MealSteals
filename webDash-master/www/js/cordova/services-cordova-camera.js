...
.factory('CordovaCamera', function($q, $cordovaCamera) {
    ...
    self.newImage = function(sourceTypeIndex, userOptions) {
        ...
        if(!angular.isUndefined(userOptions.encodingType)){
            userOptions.encodingType = Camera.EncodingType.PNG;
        }else{
            userOptions.encodingType = Camera.EncodingType.JPEG;
        }
        ...
        var options = {
		    ...
		    allowEdit :         userOptions.allowEdit,
		    targetWidth:        userOptions.targetWidth,
            targetHeight:       userOptions.targetHeight,
            correctOrientation: userOptions.correctOrientation,
		    encodingType:       userOptions.encodingType,
		    popoverOptions:     CameraPopoverOptions,
		    saveToPhotoAlbum:   userOptions.saveToPhotoAlbum
	    };
