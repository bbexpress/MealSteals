...
.factory('Codes', function(Utils, $q) {
  ...
  self.handleError = function(error) {
    Utils.showMessage(self.getErrorMessage(error), 3000);
  };
  ...
  self.getErrorMessage = function(error) {
    ...
    if (error.hasOwnProperty('code')){
      switch(error.code) {
        ...
        case 'EMAIL_TAKEN':
          //
          updateMessage = "E-mail is already associated with a MealSteals account. Forgot password? Reset it"
          break
        case 'USERNAME_TAKEN':
          //
        ...
        case 'PROFILE_NOT_SET':
          //
          updateMessage = "Please provide a username"
          break
