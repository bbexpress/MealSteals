...
.controller('DealsCtrl', function(DealProcessor, Timestamp, $cordovaSocialSharing, $ionicPopup, $scope, $firebaseObject, $firebaseArray, $rootScope, $interval, $timeout, Location, DealData, FakeDataPop, $ionicLoading, $location, $ionicActionSheet, $compile, $q, $ionDrawerVerticalDelegate, $cordovaAppRate, PopupAds) {
