...
//            }); 
    ...
    $scope.dealsTabOptions = function(deal) {
        console.log(deal);
           ...
           var retVal = confirm('Edit '+deal.name);
           if( retVal == true ){
              ...
              return true;
               ...
               var retVal = confirm('Delete '+deal.name);
               if( retVal == true ){
