...
.controller('AccountCtrl', function(
  ...
  Auth, Profile, Codes, Utils, $rootScope, AccountBase, CordovaCamera, $firebaseArray, $q, Upload, $firebaseObject, $ionicLoading, $cordovaToast, $cordovaDialogs, $jrCrop, $ionicScrollDelegate, $ionicPopover) {
              ...
              imageToDataUri(reader.result, file.width, file.height, newWidth, newHeight).then(function(hmm){
                ...
                file.upload.then(function (response) {
                  ...
                  $scope.loadingImage = false;
                    ...
                    $rootScope.changeProfileObj[saveToKey] = $scope.newImage;
